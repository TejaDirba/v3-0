...
template<typename T>
typename Vector<T>::reference Vector<T>::front() { return _data[0]; }

template<typename T>
typename Vector<T>::const_reference Vector<T>::front() const { return _data[0]; }

template<typename T>
typename Vector<T>::reference Vector<T>::back()  { return _data[_size-1]; }

template<typename T>
typename Vector<T>::const_reference Vector<T>::back() const { return _data[_size-1]; }
...
template<typename T>
void Vector<T>::reserve(size_type n) { if (n > _cap) reallocate(n); }
